...
<html lang="{{ app()->getLocale() }}">
  <head>
    ...
    <meta property="og:description" content="@hasSection('description')@yield('description')@else @yield('title'){{' • TIL - Learn new things everyday! Check out our latest tips and tricks.'}}@endif">
